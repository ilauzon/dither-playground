...
public class DialogManager
{
    ...
    private static readonly Dictionary<IDialogParticipant, Visual> RegistrationMapper = new();
    ...
    private static void RegisterChanged(Visual sender, AvaloniaPropertyChangedEventArgs e)
    {
        ...
        if (e.GetOldValue<IDialogParticipant>() is { } oldValue) RegistrationMapper.Remove(oldValue);

        // Register any new context
        if (e.GetNewValue<IDialogParticipant>() is { } newValue) RegistrationMapper.Add(newValue, sender);
    }
